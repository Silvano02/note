...
--
-- Name: folders handle_updated_at_folders; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER "handle_updated_at_folders" BEFORE UPDATE ON "public"."folders" FOR EACH ROW EXECUTE FUNCTION "extensions"."moddatetime"('updated_at');


--
-- Name: notes handle_updated_at_notes; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER "handle_updated_at_notes" BEFORE UPDATE ON "public"."notes" FOR EACH ROW EXECUTE FUNCTION "extensions"."moddatetime"('updated_at');


--
-- Name: folders folders_owner_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."folders"
    ADD CONSTRAINT "folders_owner_fkey" FOREIGN KEY ("owner") REFERENCES "auth"."users"("id");


--
-- Name: notes notes_author_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: notes notes_folder_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."notes"
    ADD CONSTRAINT "notes_folder_fkey" FOREIGN KEY ("folder") REFERENCES "public"."folders"("id");
...
CREATE POLICY "Users can delete own folders." ON "public"."folders" FOR DELETE USING (("auth"."uid"() = "owner"));


--
-- Name: notes Users can delete own notes.; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can delete own notes." ON "public"."notes" FOR DELETE USING (("auth"."uid"() = "author"));


--
-- Name: folders Users can insert their own folders.; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert their own folders." ON "public"."folders" FOR INSERT WITH CHECK (("auth"."uid"() = "owner"));


--
-- Name: notes Users can insert their own notes.; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert their own notes." ON "public"."notes" FOR INSERT WITH CHECK (("auth"."uid"() = "author"));
...
CREATE POLICY "Users can update own folders." ON "public"."folders" FOR UPDATE USING (("auth"."uid"() = "owner"));


--
-- Name: notes Users can update own notes.; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can update own notes." ON "public"."notes" FOR UPDATE USING (("auth"."uid"() = "author"));
...
CREATE POLICY "Users can view their own folders." ON "public"."folders" FOR SELECT USING (("auth"."uid"() = "owner"));


--
-- Name: notes Users can view their own notes.; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view their own notes." ON "public"."notes" FOR SELECT USING (("auth"."uid"() = "author"));
